...
if __name__ == '__main__':
	...
	try:
		...
		if(type=="train"):
			CFG_TEMPLATE=get_configvalue("TRAIN_CFG_TEMPLATE")
			CFG_FINAL=get_configvalue("rnntrain_cfg")
		elif(type=="test"):
			CFG_TEMPLATE=get_configvalue("TEST_CFG_TEMPLATE")
			CFG_FINAL=get_configvalue("rnntest_cfg")
		else:
