...
namespace data_sets {
    ...
    private:
        ...
        Cpu::real_vector    m_inputFeats;
		Cpu::int_vector    m_inputWords;
		Cpu::int_vector     m_outputLabels;
    ...
    public:
         ...
         */
        const Cpu::real_vector& inputFeats() const;

		const Cpu::int_vector& inputWords() const;

        const Cpu::real_vector& outputs() const;

        const Cpu::int_vector& outputLabels() const;
    };
