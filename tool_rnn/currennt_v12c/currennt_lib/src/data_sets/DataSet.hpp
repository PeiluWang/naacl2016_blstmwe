...
namespace data_sets {
    ...
    public:
        struct sequence_t {
            ...
            std::streampos inputFeatsBegin;
			std::streampos inputWordsBegin;
            std::streampos outputsBegin;
        };
    ...
    private:
        ...
        Cpu::real_vector _loadInputFeatsFromCache(const sequence_t &seq);
		Cpu::int_vector _loadInputWordsFromCache(const sequence_t &seq);
        Cpu::real_vector _loadOutputsFromCache(const sequence_t &seq);
        Cpu::int_vector _loadOutputLabelsFromCache(const sequence_t &seq);
