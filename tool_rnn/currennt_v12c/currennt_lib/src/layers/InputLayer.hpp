...
namespace layers {
    ...
    class InputLayer : public Layer<TDevice>
    {
		...
		real_vector v_inputfeats;

		int inputFeatDim;
		int inputWeDim;

		real_vector we_weights;
		real_vector feat_weights;
		real_vector feat_weightUpdates;

		real_vector last_weweightUpdates;
		real_vector last_featweightUpdates;

		real_vector v_outputErrors;
