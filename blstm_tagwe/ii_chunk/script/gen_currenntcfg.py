...
def main():
	...
	for line in fi:
		...
		value=value.replace("$tag_num",tag_num)
		value=value.replace("$load_transmatrix",load_transmatrix)
		value=value.replace("$save_transmatrix",save_transmatrix)
		value=value.replace("/","\\")
...
if __name__ == '__main__':
	...
	try:
		...
		tag_num = get_configvalue("tag_num")
		load_transmatrix = get_configvalue("load_transmatrix")
		save_transmatrix = get_configvalue("save_transmatrix")
		main()
