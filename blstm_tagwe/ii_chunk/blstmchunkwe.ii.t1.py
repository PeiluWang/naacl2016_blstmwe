...
import checkgpu
"""
Use BLTM to do Chunking with word embedding
"""
##############################
#Configuration
EXP_NAME=__file__.rstrip(".py")
ROOT_DIR="exp/%s"%EXP_NAME
TRAINDATA="data/conll00.train.f.iobes"
VALDATA="data/conll00.test.f.iobes"
TESTDATA="data/conll00.test.f.iobes"
transmatrix_file="data/conll00f.iobes.transmatrix"
#config file
NETWORK_CFG="resource/network.i50h100o40.jsn"
TRAIN_CFG_TEMPLATE="resource/exp.train.template.cfg"
TEST_CFG_TEMPLATE="resource/exp.test.template.cfg"
WORD_DICT="data/lowerworddict.conll00f_train-ldcallf100k"
TAG_DICT="data/conll00.train.f.iobes.tagdict"
load_weweights = "data/weweights/weweights.blstmauen_1_g-3.epoch11"
