...
This is the experimental workspace of BLSTM-RNN based Chunking tagging approach.
...
type cmd:
python blstmchunk.ii.t1.py
to run the whole Chunking experiment.

type cmd:
python blstmchunkwe.ii.t1.py
to run the whole Chunking with word embedding experiment.


Result can be found in exp