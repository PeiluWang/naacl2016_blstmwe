...
This is the experimental workspace of BLSTM-RNN based Named Entity Recognition (NER) approach.
...
type cmd:
python blstmner.iii.t1.py
to run the whole NER experiment.

type cmd:
python blstmnerwe.iii.t1.py
to run the whole NER with word embedding experiment.
